...
export default function AnimeDetailPage({ animeId }: { animeId: string }) {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const [animeRes, commentsRes, ratingRes, profileRes] = await Promise.all([
        ...
        const [animeData, commentsData, ratingData, profileData] = await Promise.all([
          animeRes.ok ? animeRes.json() : null,
        ...
        <div className="md:col-span-2">
          ...
          <div className="mb-4">
            <div className="flex items-center mb-2">
              ...
              <span className="ml-2 text-xl font-bold">{anime.rating.toFixed(1)}</span>
