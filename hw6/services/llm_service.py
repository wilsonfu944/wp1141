...
class LLMService:
    ...
    def build_prompt(self, messages: List[Message], user_message: str) -> List[Dict[str, str]]:
        """
        ...
        # System prompt - 戀愛機器人角色設定
        system_prompt = """你是一個溫暖、貼心的戀愛機器人，扮演使用者的男女朋友角色。你的特質：
